...
class HomeScreenActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        iv_menu_dashboard.setOnClickListener {
            setFragment(fragmentHome)
            changeIcon(iv_menu_dashboard, R.drawable.ic_home_active)
        ...
        iv_menu_ticket.setOnClickListener {
            ...
            changeIcon(iv_menu_dashboard, R.drawable.ic_home)
    ...
    private fun setFragment(fragment: Fragment) {
        ...
        fragmentTransaction.replace(R.id.layout_fragment_dashboard, fragment)
